<%@ Page Title="" Language="C#" MasterPageFile="~/Template/salon.master" AutoEventWireup="true" CodeFile="ServiceProviderList.aspx.cs" Inherits="Service_ServiceProviderList" %>
                                        ...
                                        <div class="col-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h3 class="card-title" style="text-align: center; color: black;">ServiceProvider List</h3>
                                                </div>
                                                <br />
                                                            ...
                                                            <asp:ListView ID="ListView1" runat="server">
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        ...
                                                                        <td><%# Eval("Password") %></td>
                                                                        <td><%# Eval("Gender") %></td>
                                                                        <td><%# Eval("DateOfjoinning") %></td>
                                                                        <td><%# Eval("IdproofPhoto") %></td>
                                                                        <td><%# Eval("ServiceProviderPhoto") %></td>
                                                                        <td><%# Eval("Status") %></td>
                                                                        <td><%# Eval("CreatedAt") %></td>
                                                                        <td><%# Eval("ModifiedAt") %></td>
                                                                        <td><a href='ServiceProvider.aspx?open=<%# Eval("Id") %>'>
                                                                            <button class="btn btn-primary">Open</button></a>
                                                                            <a href='ServiceProvider.aspx?delete=<%# Eval("Id") %>'>
