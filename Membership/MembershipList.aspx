<%@ Page Title="" Language="C#" MasterPageFile="~/Template/salon.master" AutoEventWireup="true" CodeFile="MembershipList.aspx.cs" Inherits="Membership_MembershipList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Hair Zone | Membership List</title>
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <div style="align-items: center;">
                            <h1 style="color: black;">Membership Detail</h1>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right" style="float: right;">
                            <li class="breadcrumb-item"><a href="Membership.aspx">Add New MemberShip</a></li>
                                        ...
                                        <div class="col-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h3 class="card-title" style="text-align: center; color: black;">Membership List</h3>
                                                </div>
                                                <br />
                                                            ...
                                                            <asp:ListView ID="ListView1" runat="server">
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        ...
                                                                        <td><%# Eval("MembershipPrice") %></td>
                                                                        <td><%# Eval("Duration") %></td>
                                                                        <td><%# Eval("RewardPointOnPurchase") %></td>
                                                                        <td><%# Eval("DiscountOnService") %></td>
                                                                        <td><%# Eval("DiscountOnServiceType") %></td>
                                                                        <td><%# Eval("DiscountOnProduct") %></td>
                                                                        <td><%# Eval("DiscountOnProductType") %></td>
                                                                        <td><%# Eval("DiscountOnPackage") %></td>
                                                                        <td><%# Eval("DiscountOnPackageType") %></td>
                                                                        <td><%# Eval("RewardPointBoost") %></td>
                                                                        <td><%# Eval("MinimumRewardPoint") %></td>
                                                                        <td><%# Eval("MinimumBillAmount") %></td>
                                                                        <td><%# Eval("Status") %></td>
                                                                        <td><%# Eval("CreatedAt") %></td>
                                                                        <td><%# Eval("ModifiedAt") %></td>
                                                                        <td><a href='Membership.aspx?open=<%# Eval("Id") %>'>
                                                                            <button class="btn btn-primary">Open</button></a>
                                                                            <a href='Membership.aspx?delete=<%# Eval("Id") %>'>
