<%@ Page Title="" Language="C#" MasterPageFile="~/Template/salon.master" AutoEventWireup="true" CodeFile="BranchList.aspx.cs" Inherits="Branch_BranchList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Hair Zone Salon| Branch List</title>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right" style="float: right;">
                            <li class="breadcrumb-item"><a href="Membership.aspx">Add New Branch</a></li>
                                        ...
                                        <div class="col-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h3 class="card-title" style="text-align: center; color: black;">Branch List</h3>
                                                </div>
                                                <br />
                                                            ...
                                                            <asp:ListView ID="ListView1" runat="server">
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        ...
                                                                        <td><%# Eval("BranchPhoto") %></td>
                                                                        <td><%# Eval("BranchType") %></td>
                                                                        <td><a href='BranchAdd.aspx?open=<%# Eval("Id") %>'>
                                                                            <button class="btn btn-primary">Open</button></a>
                                                                            <a href='BranchAdd.aspx?delete=<%# Eval("Id") %>'>
