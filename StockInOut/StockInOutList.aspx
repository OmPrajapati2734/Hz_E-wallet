<%@ Page Title="" Language="C#" MasterPageFile="~/Template/salon.master" AutoEventWireup="true" CodeFile="StockInOutList.aspx.cs" Inherits="StockInOut_StockInOutList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Hair Zone Sali | StockInOut List</title>
                                        ...
                                        <div class="col-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h3 class="card-title" style="text-align: center; color: black;">StockInOut List</h3>
                                                </div>
                                                <br />
                                                            ...
                                                            <asp:ListView ID="ListView1" runat="server">
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        ...
                                                                        <td><%# Eval("TotalTaxableAmount") %></td>
                                                                        <td><%# Eval("TotalGST") %></td>
                                                                        <td><%# Eval("TotalIGST") %></td>
                                                                        <td><%# Eval("TotalCGST") %></td>
                                                                        <td><%# Eval("TotalSGST") %></td>
