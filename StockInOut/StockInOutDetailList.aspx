<%@ Page Title="" Language="C#" MasterPageFile="~/Template/salon.master" AutoEventWireup="true" CodeFile="StockInOutDetailList.aspx.cs" Inherits="StockInOut_StockInOutDetailList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Hair Salon | StockInOutDetail</title>
                                        ...
                                        <div class="col-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h3 class="card-title" style="text-align: center; color: black;">StockInOutDetail List</h3>
                                                </div>
                                                <br />
                                                            ...
                                                            <asp:ListView ID="ListView1" runat="server">
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        ...
                                                                        <td><%# Eval("GSTPercentage") %></td>
                                                                        <td><%# Eval("GSTAmount") %></td>
                                                                        <td><%# Eval("CGSTAmount") %></td>
                                                                        <td><%# Eval("SGSTAmount") %></td>
                                                                        <td><%# Eval("IGSTAmount") %></td>
                                                                        <td><%# Eval("NetAmount") %></td>
                                                                        <td><%# Eval("Unit") %></td>
                                                                        <td><%# Eval("Remark") %></td>
                                                                        <td><%# Eval("CreatedAt") %></td>
                                                                        <td><%# Eval("ModifiedAt") %></td>
                                                                        <td><a href='StockInOut.aspx?open=<%# Eval("Id") %>'>
                                                                            <button class="btn btn-primary">Open</button></a>
                                                                            <a href='StockInOut.aspx?delete=<%# Eval("Id") %>'>
